...
class GAN:
	...
	def classify(self):
		...
		self.generator.load_weights('./save/wgan_checkpoint.h5')
	...
	def gradient_penalty(self, G, real_images, fake_images):
	...
	def train(self):
		...
		self.generator.save_weights('./save/wgan_checkpoint.h5')
	...
	def train_step(self,real_images):
		...
		with tf.GradientTape() as d_tape, tf.GradientTape() as g_tape:
			...
			gp = self.gradient_penalty(partial(self.discriminator),
